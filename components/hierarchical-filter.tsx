...
const hierarchyData = {
  ...
  subregions: [
    ...
    { id: "northern-europe", label: "Northern Europe", parent: "europe" },
    { id: "southern-europe", label: "Southern Europe", parent: "europe" },
    { id: "southeast-asia", label: "Southeast Asia", parent: "asia" },
  ],
  businessRegions: [
    { id: "nl.onshore", label: "NL.Onshore", parent: "western-europe" },
    { id: "nl.offshore", label: "NL.Offshore", parent: "western-europe" },
    { id: "uk.northsea", label: "UK.North Sea", parent: "western-europe" },
  ],
  countries: [
    { id: "netherlands", label: "Netherlands", parent: "western-europe" },
    { id: "united-kingdom", label: "United Kingdom", parent: "western-europe" },
    { id: "germany", label: "Germany", parent: "western-europe" },
    { id: "malaysia", label: "Malaysia", parent: "southeast-asia" },
  ],
  basins: [
    { id: "southern-permian", label: "Southern Permian Basin", parent: "netherlands" },
    { id: "west-netherlands", label: "West Netherlands Basin", parent: "netherlands" },
    { id: "broad-fourteens", label: "Broad Fourteens Basin", parent: "netherlands" },
    { id: "central-graben", label: "Central Graben", parent: "netherlands" },
    { id: "vims", label: "Vlieland Basin (VIMS)", parent: "netherlands" },
  ],
  subbasins: [
    { id: "f3-block", label: "F3 Block Area", parent: "central-graben" },
    { id: "l13-block", label: "L13 Block Area", parent: "broad-fourteens" },
    { id: "p11-block", label: "P11 Block Area", parent: "west-netherlands" },
  ],
}
